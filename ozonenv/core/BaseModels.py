...
class User(BasicModel):
    ...
    def all_fields(cls) -> list:
        return {'is_admin': {'label': 'Admin', 'tableView': False, 'defaultValue': False,
                             'key': 'is_admin', 'type': 'checkbox', 'input': True,
                             'properties': {}, 'validate': {}},
                'is_bot': {'label': 'Bot', 'tableView': False, 'defaultValue': False,
                           'key': 'is_bot', 'type': 'checkbox', 'input': True,
                           'properties': {}, 'validate': {}},
                'is_api': {'label': 'API User', 'tableView': False,
                           'defaultValue': False, 'key': 'is_api', 'type': 'checkbox',
                           'input': True, 'properties': {}, 'validate': {}},
                'use_auth': {'label': 'Usa Auth', 'tableView': False,
                             'defaultValue': True, 'key': 'use_auth', 'type': 'checkbox',
                             'input': True, 'properties': {}, 'validate': {}},
                'active': {'label': 'Active', 'tableView': False, 'defaultValue': True,
                           'key': 'active', 'type': 'checkbox', 'input': True,
                           'properties': {}, 'validate': {}},
                'default': {'label': 'Default', 'tableView': False, 'defaultValue': True,
                            'key': 'default', 'type': 'checkbox', 'input': True,
                            'properties': {}, 'validate': {}},
                'tech_admin': {'label': 'Tech Admin', 'tableView': False,
                               'defaultValue': False, 'key': 'tech_admin',
                               'type': 'checkbox', 'input': True, 'properties': {},
                               'validate': {}},
                'is_public': {'label': 'Pubblico', 'tableView': False,
                              'defaultValue': False, 'key': 'is_public',
                              'type': 'checkbox', 'input': True, 'properties': {},
                              'validate': {}},
                'uid': {'label': 'Username', 'tableView': True, 'key': 'uid',
                        'type': 'textfield', 'input': True,
                        'validate': {'required': True}, 'unique': True,
                        'properties': {}},
                'password': {'label': 'Password', 'tableView': False, 'key': 'password',
                             'type': 'password', 'input': True, 'protected': True,
                             'properties': {}, 'validate': {}},
                'rec_name': {'label': 'Rec Name', 'tableView': True, 'key': 'rec_name',
                             'type': 'textfield', 'input': True,
                             'validate': {'required': True}, 'unique': True,
                             'properties': {}},
                'cognome': {'label': 'Cognome', 'tableView': True, 'key': 'cognome',
                            'type': 'textfield', 'input': True, 'properties': {},
                            'validate': {}},
                'nome': {'label': 'Nome', 'tableView': True, 'key': 'nome',
                         'type': 'textfield', 'input': True, 'properties': {},
                         'validate': {}},
                'full_name': {'label': 'Nome Completo', 'tableView': True,
                              'key': 'full_name', 'type': 'textfield', 'input': True,
                              'properties': {}, 'validate': {}},
                'mail': {'label': 'Email', 'tableView': True, 'key': 'mail',
                         'type': 'textfield', 'input': True, 'properties': {},
                         'validate': {}},
                'matricola': {'label': 'Matricola', 'tableView': True,
                              'key': 'matricola', 'type': 'textfield', 'input': True,
                              'properties': {}, 'validate': {}},
                'codicefiscale': {'label': 'Codice Fiscale', 'tableView': True,
                                  'key': 'codicefiscale', 'type': 'textfield',
                                  'input': True, 'properties': {}, 'validate': {}},
                'client_id': {'label': 'Client ID', 'tableView': True,
                              'key': 'client_id', 'type': 'textfield', 'input': True,
                              'properties': {}, 'validate': {}},
                'user_function': {'label': 'Funzione Utente', 'tableView': True,
                                  'key': 'user_function', 'type': 'textfield',
                                  'input': True, 'properties': {}, 'validate': {}},
                'function': {'label': 'Function', 'tableView': True, 'key': 'function',
                             'type': 'textfield', 'input': True, 'properties': {},
                             'validate': {}},
                'sector': {'label': 'Settore', 'tableView': True, 'key': 'sector',
                           'type': 'textfield', 'input': True, 'properties': {},
                           'validate': {}},
                'sector_id': {'label': 'Sector ID', 'tableView': True,
                              'key': 'sector_id', 'type': 'number', 'input': True,
                              'delimiter': False, 'requireDecimal': False,
                              'truncateMultipleSpaces': False,
                              'validate': {'integer': True}, 'defaultValue': 0,
                              'properties': {}},
                'sector_code': {'label': 'Sector Code', 'tableView': True,
                                'key': 'sector_code', 'type': 'textfield', 'input': True,
                                'properties': {}, 'validate': {}},
                'tz': {'label': 'Timezone', 'tableView': True, 'key': 'tz',
                       'type': 'textfield', 'input': True, 'defaultValue': 'Europe/Rome',
                       'properties': {}, 'validate': {}},
                'parent': {'label': 'Parent', 'tableView': True, 'key': 'parent',
                           'type': 'textfield', 'input': True, 'properties': {},
                           'validate': {}},
                'req_id': {'label': 'Req ID', 'tableView': True, 'key': 'req_id',
                           'type': 'textfield', 'input': True, 'properties': {},
                           'validate': {}},
                'last_update': {'label': 'Last Update', 'tableView': True,
                                'key': 'last_update', 'type': 'number', 'input': True,
                                'delimiter': False, 'requireDecimal': False,
                                'truncateMultipleSpaces': False,
                                'validate': {'integer': True}, 'defaultValue': 0,
                                'properties': {}},
                'last_login': {'label': 'Last Login', 'tableView': True,
                               'key': 'last_login', 'type': 'datetime', 'input': True,
                               'format': 'yyyy-MM-dd HH:mm',
                               'datePicker': {'disableWeekends': False,
                                              'disableWeekdays': False},
                               'timePicker': {'showMeridian': False},
                               'widget': {'type': 'calendar',
                                          'displayInTimezone': 'viewer', 'locale': 'en',
                                          'useLocaleSettings': False, 'allowInput': True,
                                          'mode': 'single', 'enableTime': True,
                                          'noCalendar': False,
                                          'format': 'yyyy-MM-dd HH:mm',
                                          'hourIncrement': 1, 'minuteIncrement': 1,
                                          'time_24hr': True, 'minDate': None,
                                          'disableWeekends': False,
                                          'disableWeekdays': False, 'maxDate': None},
                               'properties': {}, 'validate': {}}}
    ...
    @classmethod
    def datetime_fields(cls):
        return {'update_datetime': {'transform': {'type': 'datetime'}},
                'create_datetime': {'transform': {'type': 'datetime'}},
                'last_login': {'ctype': 'datetime', 'disabled': False, 'readonly': False,
                               'hidden': False, 'required': False, 'unique': False,
                               'component': 'Component', 'calculateServer': None,
    ...
    @classmethod
    def tranform_data_value(cls):
        return {'last_login': {'type': 'datetime'}}

    @classmethod
    def filter_keys(cls):
        return ['is_admin', 'is_bot', 'is_api', 'use_auth', 'active', 'default',
                'tech_admin', 'is_public', 'uid', 'password', 'rec_name', 'cognome',
                'nome', 'full_name', 'mail', 'matricola', 'codicefiscale', 'client_id',
                'user_function', 'function', 'sector', 'sector_id', 'sector_code', 'tz',
                'parent', 'req_id', 'last_update', 'last_login']

    @classmethod
    def table_columns(cls) -> dict:
        return {'uid': 'Username', 'rec_name': 'Rec Name', 'cognome': 'Cognome',
                'nome': 'Nome', 'full_name': 'Nome Completo', 'mail': 'Email',
                'matricola': 'Matricola', 'codicefiscale': 'Codice Fiscale',
                'client_id': 'Client ID', 'user_function': 'Funzione Utente',
                'function': 'Function', 'sector': 'Settore', 'sector_id': 'Sector ID',
                'sector_code': 'Sector Code', 'tz': 'Timezone', 'parent': 'Parent',
                'req_id': 'Req ID', 'last_update': 'Last Update',
