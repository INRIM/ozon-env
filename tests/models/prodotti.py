...
#   timestamp: 2025-05-27T12:07:52+00:00
...
class Prodotti(BasicModel):
    rec_name: Optional[str] = Field('', title='Nome')
    label: Optional[str] = Field('', title='Descrizione')
    quantity: Optional[int] = Field(0, title='Qt')
